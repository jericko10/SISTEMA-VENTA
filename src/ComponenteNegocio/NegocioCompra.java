...
public class NegocioCompra {
    ...
    */  
    ...
    public void eliminarFilaEsperaProductoCliente(final int idProductoCliente) throws SQLException{
        BaseDatosCompra.eliminarFilaEsperaProductoCliente(idProductoCliente);
    }
