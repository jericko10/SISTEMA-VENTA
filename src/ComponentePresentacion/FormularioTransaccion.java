...
public class FormularioTransaccion extends javax.swing.JFrame {
    ...
    *
    */
    public FormularioTransaccion() throws SQLException{
        try {
    ...
    */ 
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(filaSeleccionada>=0){
            ...
            try {
                compraNegocio.eliminarFilaEsperaProductoCliente(idProductoCliente);
    ...
    private void btnListarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarProductoActionPerformed
        DefaultTableModel modelo=(DefaultTableModel) jtTransacProd.getModel();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new FormularioTransaccion().setVisible(true);
                } catch (SQLException ex) {
                }
            }
        });
